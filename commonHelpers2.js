import{c as C,b as F,a as I,i as p,h as T,s as D,g as _,o as z,n as H}from"./assets/change-theme-736e1fb7.js";import{i as f}from"./assets/vendor-0a7943b3.js";const v=async e=>{const t=l=>{const n=l;if(n==="Muscles")return n.toLowerCase();if(n==="Body parts")return"bodypart";if(n==="Equipment")return n.toLowerCase()},s={...e},r=await C.getFilters(s),o=r.data.results;return F(r.data.totalPages,e.page),o.reduce((l,n)=>l+` <li class="render-page-one-item" data-filter="${t(e.filter)}" data-name="${n.name}">
